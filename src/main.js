...
<div class="d-flex justify-content-between flex-column min-vh-100">
  <div class="container pt-5">
    <h1 class="text-center mb-5">Variant B</h1>
          ...
          <div class="card-body d-flex flex-column gap-4">
            ...
            <div>
              <ul class="nav nav-pills tab-secondary gap-2 d-flex flex-row" id="myItems" role="tablist">
                ...
                <li class="nav-item">
                  <button aria-controls="item3" aria-selected="false" class="nav-link disabled" data-bs-target="#item3"
                          data-bs-toggle="tab"
                          id="item3-tab" role="tab" type="button">Disable item
                  </button>
                </li>
                <li class="nav-item">
